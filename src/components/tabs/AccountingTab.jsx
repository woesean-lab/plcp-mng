            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-ink-900/70 px-4 py-4 shadow-inner sm:px-5">
              ...
              <div className="relative">
                ...
                <div className="mt-3 rounded-xl border border-white/10 bg-white/5 px-3 py-2.5">
                  ...
                  <p className="mt-1 text-base font-semibold text-slate-100">TL {preciseCurrency(totalBalanceTry)}</p>
                  <p className="mt-1 text-[11px] text-slate-400">Kur: 1 USD = {preciseCurrency(USD_TO_TRY_RATE)} TL</p>
                </div>
