                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="space-y-1">
                          ...
                          {formatProblemCreatedAt(pb.createdAt) && (
                            <span className="inline-flex items-center rounded-md border border-white/10 bg-ink-950/60 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.12em] text-slate-400">
                              {formatProblemCreatedAt(pb.createdAt)}
                            </span>
                          )}
                        </div>
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex flex-col gap-1">
                          ...
                          {formatProblemCreatedAt(pb.createdAt) && (
                            <span className="inline-flex items-center rounded-md border border-emerald-200/40 bg-emerald-950/40 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.12em] text-emerald-100/70">
                              {formatProblemCreatedAt(pb.createdAt)}
                            </span>
                          )}
                        </div>
