        ...
        <div className="space-y-4 p-4">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-lg border border-white/15 bg-ink-950 px-3 py-2 text-sm text-slate-100 placeholder:text-slate-500 focus:border-accent-400 focus:outline-none focus:ring-2 focus:ring-accent-500/30"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full appearance-none rounded-lg border border-white/15 bg-ink-950 px-3 py-2 text-sm text-slate-100 focus:border-accent-400 focus:outline-none focus:ring-2 focus:ring-accent-500/30"
            >
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full appearance-none rounded-lg border border-white/15 bg-ink-950 px-3 py-2 pr-3 text-sm text-slate-100 focus:border-accent-400 focus:outline-none focus:ring-2 focus:ring-accent-500/30"
            >
          ...
          {draft.dueType === "date" && (
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/15 bg-ink-950 px-3 py-2 text-sm text-slate-100 focus:border-accent-400 focus:outline-none focus:ring-2 focus:ring-accent-500/30"
              />
            </div>
          )}
        </div>
