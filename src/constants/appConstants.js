...
export const PERMISSIONS = {
  ...
  productsMessageTemplateAdd: "products.message.template.add",
  productsMessageTemplateEdit: "products.message.template.edit",
  productsMessageTemplateDelete: "products.message.template.delete",
...
export const PERMISSION_GROUPS = [
  {
    ...
    items: [
      ...
      { id: PERMISSIONS.productsMessageTemplateAdd, label: "Urun mesaji ekle" },
      { id: PERMISSIONS.productsMessageTemplateEdit, label: "Urun mesaji duzenle" },
      { id: PERMISSIONS.productsMessageTemplateDelete, label: "Urun mesaji sil" },
      ...
      { id: PERMISSIONS.productsPriceCommandLogsView, label: "Fiyat komut ciktilarini gor" },
      { id: PERMISSIONS.productsStockFetch, label: "Stok cek panelini gor" },
      { id: PERMISSIONS.productsStockFetchEdit, label: "Stok cek hedef yonet" },
      { id: PERMISSIONS.productsStockFetchRun, label: "Stok cek calistir" },
      { id: PERMISSIONS.productsStockFetchLogsView, label: "Stok cek CMD gor" },
      { id: PERMISSIONS.productsStockFetchLogsClear, label: "Stok cek log temizle" },
      { id: PERMISSIONS.productsStockFetchStar, label: "Stok cek hedef yildizla" },
  ...
  },
  {
    title: "Admin",
    items: [
      { id: PERMISSIONS.automationView, label: "Websocket ayarlari" },
